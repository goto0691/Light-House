        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 rounded-lg border border-white/10 bg-white/5 p-3">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">작업의 canonical 필드를 한 곳에서 조정합니다.</p>
            </div>
            <button
          ...
          <section className="rounded-3xl border border-white/10 bg-white/5 p-4">
            ...
            <p className="mt-1 text-sm text-muted-foreground">메모: {task.linkedZettels.join(", ") || "없음"}</p>
          </section>
        </div>
      )}
