        ...
        <div className="mt-5 space-y-3">
          {people.length ? (
            people.map((person, index) => (
              <Link
                className="block rounded-lg border border-white/10 bg-white/5 p-4 hover:border-primary/20 hover:bg-white/8"
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 text-xs text-danger">{person.daysSinceContact - person.cadenceDays}일 지남</p>
                  </div>
