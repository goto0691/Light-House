    ...
    <BentoCard colSpan={8} rowSpan={2}>
      <GlassCard className="h-full" interactive>
        <div className="flex items-center justify-between gap-3">
          ...
          <span className="rounded-full border border-primary/20 bg-primary/10 px-3 py-1.5 text-xs uppercase tracking-[0.18em] text-primary">
            best streak {bestStreak}
          </span>
        </div>
        <div className="mt-5 overflow-hidden rounded-[24px] border border-white/10 bg-black/10 p-3">
          <Heatmap data={heatmapData} />
        </div>
        <div className="mt-4">
          <Link className="text-xs uppercase tracking-[0.18em] text-primary" href="/life-ops">
            Open calendar
          </Link>
        </div>
      </GlassCard>
